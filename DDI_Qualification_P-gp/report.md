 ...
 * [1 Introduction](#introduction)
   ...
   * [1.2 Pgp DDI Network](#pgp-ddi-network)
     ...
     * [1.2.4 Rifampicin - Digoxin DDI](#rifampicin-digoxin-ddi)
     * [1.2.5 Verapamil - Digoxin DDI](#verapamil-digoxin-ddi)
     * [1.2.6 Clarithromycin - Dabigatran DDI](#clarithromycin-dabigatran-ddi)
     * [1.2.7 Itraconazole - Dabigatran DDI](#itraconazole-dabigatran-ddi)
     * [1.2.8 Rifampicin - Dabigatran DDI](#rifampicin-dabigatran-ddi)
     * [1.2.9 Verapamil - Dabigatran DDI](#verapamil-dabigatran-ddi)
 * [2 Qualification of Use Case Pgp-mediated DDI](#qualification-of-use-case-pgp-mediated-ddi)
   ...
   * [2.3 Victim](#qualification-of-use-case-pgp-mediated-ddi-ddi-subunit-75)
     * [2.3.1 Dabigatran](#qualification-of-use-case-pgp-mediated-ddi-ddi-subunit-76)
     * [2.3.2 Digoxin](#qualification-of-use-case-pgp-mediated-ddi-ddi-subunit-84)
 * [3 Concentration-Time Profiles](#concentration-time-profiles)
   ...
   * [3.4 Rifampicin - Digoxin DDI](#rifampicin-digoxin-ddi-timeprofile)
   * [3.5 Verapamil - Digoxin DDI](#verapamil-digoxin-ddi-timeprofile)
   * [3.6 Clarithromycin - Dabigatran DDI](#clarithromycin-dabigatran-ddi-timeprofile)
   * [3.7 Itraconazole - Dabigatran DDI](#itraconazole-dabigatran-ddi-timeprofile)
   * [3.8 Rifampicin - Dabigatran DDI](#rifampicin-dabigatran-ddi-timeprofile)
   * [3.9 Verapamil - Dabigatran DDI](#verapamil-dabigatran-ddi-timeprofile)
...
The release of the snapshot containing the respective simulations can be found here: [https://github.com/Open-Systems-Pharmacology/Erythromycin-Digoxin-DDI/releases/tag/v1.1](https://github.com/Open-Systems-Pharmacology/Erythromycin-Digoxin-DDI/releases/tag/v1.1)
...
### 1.2.4 Rifampicin - Digoxin DDI<a id="rifampicin-digoxin-ddi"></a>
...
### 1.2.5 Verapamil - Digoxin DDI<a id="verapamil-digoxin-ddi"></a>
...
### 1.2.6 Clarithromycin - Dabigatran DDI<a id="clarithromycin-dabigatran-ddi"></a>

The release of the snapshot containing the respective simulations can be found here: [https://github.com/Open-Systems-Pharmacology/Clarithromycin-Dabigatran-DDI](https://github.com/Open-Systems-Pharmacology/Clarithromycin-Dabigatran-DDI)

The clarithromycin-dabigatran interaction was evaluated using 4 clinical DDI studies including 4 different clinical settings ([Prueksaritanont 2017](#references)).

| DataID | Transporter | Perpetrator / victim       | Study design                                                 | Comment                                                      | Clinical study                        |
| ------ | ------ | -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------- |
| 1806    | P-gp | Clarithromycin / dabigatran | Clarithromycin: 500 mg po twice daily (7 doses) <br />Dabigatran etexilate: 300 mg po single dose, simultaneous with 7th clarithromycin dose|        | [Delavenne 2013](#references)          |
| 1808    | P-gp | Clarithromycin / dabigatran | Clarithromycin: 500 mg po twice daily (12 doses) <br />Dabigatran etexilate: 150 mg po single dose, 1 h after 11th clarithromycin dose| The DDI ratios shown are from "free" dabigatran geometric means in the internal report, not from "total" dabigatran geometric means as shown in the EMA Summary of Product Characteristics (SmPC: AUC ratio 1.19, Cmax ratio 1.15).            | [European Medicines Agency 2025](#references)          |
| 1807    | P-gp | Clarithromycin / dabigatran | Clarithromycin: 500 mg po twice daily (10 doses) <br />Dabigatran etexilate: 300 mg po single dose, simultaneous with 9th clarithromycin dose|        | [Gouin-Thibault 2017](#references)          |
| 1805    | P-gp | Clarithromycin / dabigatran | Clarithromycin: 500 mg po twice daily (10 doses) <br />Dabigatran etexilate: 0.375 mg po single dose cocktail solution, simultaneous with 7th clarithromycin dose|        | [Prueksaritanont 2017](#references)          |

### 1.2.7 Itraconazole - Dabigatran DDI<a id="itraconazole-dabigatran-ddi"></a>

The release of the snapshot containing the respective simulations can be found here: [https://github.com/Open-Systems-Pharmacology/Itraconazole-Dabigatran-DDI](https://github.com/Open-Systems-Pharmacology/Itraconazole-Dabigatran-DDI)

The itraconazole-dabigatran interaction was evaluated using one clinical DDI study ([Prueksaritanont 2017](#references)).

| DataID | Transporter | Perpetrator / victim       | Study design                                                 | Comment                                                      | Clinical study                        |
| ------ | ------ | -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------- |
| 1804    | P-gp | Itraconazole / dabigatran | Itraconazole: 200 mg po once daily (5 doses) <br />Dabigatran etexilate: 0.375 mg po single dose cocktail solution, simultaneous with 4th itraconazole dose|        | [Prueksaritanont 2017](#references)          |

### 1.2.8 Rifampicin - Dabigatran DDI<a id="rifampicin-dabigatran-ddi"></a>

The release of the snapshot containing the respective simulations can be found here: [https://github.com/Open-Systems-Pharmacology/Rifampicin-Dabigatran-DDI](https://github.com/Open-Systems-Pharmacology/Rifampicin-Dabigatran-DDI)

The rifampicin-dabigatran interaction was evaluated using 3 clinical DDI studies including 3 different clinical settings ([Haertter 2012](#references),[Prueksaritanont 2017](#references),[Rattanacheeworn 2021](#references)).

| DataID | Transporter | Perpetrator / victim       | Study design                                                 | Comment                                                      | Clinical study                        |
| ------ | ------ | -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------- |
| 1801    | P-gp | Rifampicin / dabigatran | Rifampicin: 600 mg po once daily in the evening (7 doses) <br />Dabigatran etexilate: 150 mg po single dose capsule, 12 h after the last rifampicin dose| The DDI ratios shown are from "free" dabigatran geometric means in the internal report, not from "total" dabigatran geometric means as shown in the publication (paper: AUC ratio 0.33, Cmax ratio 0.34).            | [Haertter 2012](#references)          |
| 1803    | P-gp | Rifampicin / dabigatran | Rifampicin: 600 mg po single dose <br />Dabigatran etexilate: 0.375 mg po single dose cocktail solution, simultaneous with rifampicin dose|        | [Prueksaritanont 2017](#references)          |
| 1802    | P-gp | Rifampicin / dabigatran | Rifampicin: 450 mg po single dose <br />Dabigatran etexilate: 0.75 mg po single dose cocktail solution, simultaneous with rifampicin dose|        | [Rattanacheeworn 2021](#references)          |

### 1.2.9 Verapamil - Dabigatran DDI<a id="verapamil-dabigatran-ddi"></a>
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
|:----------------------------|:------|:---------|
|Points total                 |41     |-        |
|Points within Guest *et al.* |21     |51.22     |
|Points within 2 fold         |39     |95.12     |
...
|:----------------------------|:------|:---------|
|Points total                 |36     |-        |
|Points within Guest *et al.* |19     |52.78     |
|Points within 2 fold         |31     |86.11     |
...
|1800   |Verapamil, 120 mg, PO, -                                       |Dabigatran, PO |2.05                     |2.37                    |0.86                    |1.57                  |2.70                 |0.58                 |Boehringer 1160-0074 |
|1801   |Rifampicin, 600 mg, PO, -                                      |Dabigatran, PO |0.28                     |0.31                    |0.89                    |0.28                  |0.34                 |0.82                 |Boehringer 1160-0100 |
|1802   |Rifampicin, 450 mg, PO, -                                      |Dabigatran, PO |0.73                     |2.22                    |0.33                    |0.90                  |1.86                 |0.48                 |Rattanacheeworn 2021 |
|1803   |Rifampicin, 600 mg, PO, -                                      |Dabigatran, PO |0.72                     |2.32                    |0.31                    |0.85                  |1.79                 |0.48                 |Prueksaritanont 2017 |
|1804   |Itraconazole, 200 mg, PO, -                                    |Dabigatran, PO |7.19                     |6.92                    |1.04                    |21.89                 |6.42                 |3.41                 |Prueksaritanont 2017 |
|1805   |Clarithromycin, 500 mg, PO, -                                  |Dabigatran, PO |4.43                     |4.02                    |1.10                    |14.16                 |4.58                 |3.09                 |Prueksaritanont 2017 |
|1806   |Clarithromycin, 500 mg, PO, -                                  |Dabigatran, PO |1.08                     |1.49                    |0.73                    |1.06                  |1.60                 |0.66                 |Delavenne 2013       |
|1807   |Clarithromycin, 500 mg, PO, -                                  |Dabigatran, PO |1.02                     |1.97                    |0.52                    |0.94                  |1.71                 |0.55                 |Gouin-Thibault 2017  |
|1808   |Clarithromycin, 500 mg, PO, -                                  |Dabigatran, PO |1.28                     |1.19                    |1.08                    |1.17                  |1.21                 |0.97                 |Boehringer 1160-0082 |
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Induction_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Induction_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Induction_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Induction_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Mechanism_based_Inactivation_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Mechanism_based_Inactivation_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Mechanism_based_Inactivation_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Mechanism_based_Inactivation_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Reversible_Inhibition_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Reversible_Inhibition_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Reversible_Inhibition_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_mechanism_Reversible_Inhibition_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
|:----------------------------|:------|:---------|
|Points total                 |21     |-        |
|Points within Guest *et al.* |10     |47.62     |
|Points within 2 fold         |17     |80.95     |
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Clarithromycin_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Clarithromycin_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Clarithromycin_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Clarithromycin_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
|:----------------------------|:------|:---------|
|Points total                 |15     |-        |
|Points within Guest *et al.* |8      |53.33     |
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Erythromycin_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Erythromycin_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Erythromycin_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Erythromycin_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Itraconazole_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Itraconazole_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Itraconazole_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Itraconazole_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Rifampicin_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Rifampicin_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Rifampicin_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Rifampicin_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
|:----------------------------|:------|:---------|
|Points total                 |16     |-        |
|Points within Guest *et al.* |3      |18.75     |
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Verapamil_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Verapamil_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Verapamil_ddi_ratio_plot_C_max_predictedVsObserved.png)
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_perpetrator_Verapamil_ddi_ratio_plot_C_max_residualsVsObserved.png)
...
### 2.3.1 Dabigatran<a id="qualification-of-use-case-pgp-mediated-ddi-ddi-subunit-76"></a>

<a id="figure-2-37"></a>

![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Dabigatran_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)

**Figure 2-37: Pgp DDI. Victim: Dabigatran. Predicted vs. Observed AUC_tEnd Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Dabigatran_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)

**Figure 2-38: Pgp DDI. Victim: Dabigatran. Predicted/Observed vs. Observed AUC_tEnd Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Dabigatran_ddi_ratio_plot_C_max_predictedVsObserved.png)

**Figure 2-39: Pgp DDI. Victim: Dabigatran. Predicted vs. Observed C_max Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Dabigatran_ddi_ratio_plot_C_max_residualsVsObserved.png)

**Figure 2-40: Pgp DDI. Victim: Dabigatran. Predicted/Observed vs. Observed C_max Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
|:----------------------------|:------|:---------|
|Points total                 |9      |-        |
|Points within Guest *et al.* |5      |55.56     |
|Points within 2 fold         |7      |77.78     |
...
|:----------------------------|:------|:---------|
|Points total                 |9      |-        |
|Points within Guest *et al.* |2      |22.22     |
|Points within 2 fold         |5      |55.56     |

<br>
<br>

### 2.3.2 Digoxin<a id="qualification-of-use-case-pgp-mediated-ddi-ddi-subunit-84"></a>

<a id="figure-2-41"></a>

![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Digoxin_ddi_ratio_plot_AUC_tEnd_predictedVsObserved.png)

**Figure 2-41: Pgp DDI. Victim: Digoxin. Predicted vs. Observed AUC_tEnd Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Digoxin_ddi_ratio_plot_AUC_tEnd_residualsVsObserved.png)

**Figure 2-42: Pgp DDI. Victim: Digoxin. Predicted/Observed vs. Observed AUC_tEnd Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Digoxin_ddi_ratio_plot_C_max_predictedVsObserved.png)

**Figure 2-43: Pgp DDI. Victim: Digoxin. Predicted vs. Observed C_max Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/013_section_qualification-of-use-case-pgp-mediated-ddi/DDIRatio_1_victim_Digoxin_ddi_ratio_plot_C_max_residualsVsObserved.png)

**Figure 2-44: Pgp DDI. Victim: Digoxin. Predicted/Observed vs. Observed C_max Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
**Table 2-32: GMFE for Pgp DDI Ratio**
...
**Table 2-33: Summary table for Pgp DDI - AUC_tEnd Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
**Table 2-34: Summary table for Pgp DDI - C_max Ratio. (&delta; = 1 in Guest *et al.* formula)**
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Rengelshausen_2003__0_01_mg_kg_IV____Plasma_1.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Rengelshausen_2003__0_75_mg_PO____Plasma_2.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Tsutsumi_2002__0_5mg_IV____Plasma_3.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2008__0_25_mg_PO____Plasma_4.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2006__0_4_mg_PO____Plasma_5.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2007__0_5_mg_PO____Plasma_6.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Kurata_2002__0_5_mg_IV____Plasma_7.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Kurata_2002__0_5_mg_PO____Plasma_8.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Kurata_2002__0_25_mg_IV____Plasma_9.png)
...
![](images/014_section_concentration-time-profiles/015_section_clarithromycin-digoxin-ddi-timeprofile/comparison_time_profile_Kurata_2002__0_25_mg_PO____Plasma_10.png)
...
![](images/014_section_concentration-time-profiles/016_section_erythromycin-digoxin-ddi-timeprofile/comparison_time_profile_Tsutsumi_2002___Plasma_11.png)
...
![](images/014_section_concentration-time-profiles/017_section_itraconazole-digoxin-ddi-timeprofile/comparison_time_profile_Jalava_1997_12.png)
...
![](images/014_section_concentration-time-profiles/017_section_itraconazole-digoxin-ddi-timeprofile/comparison_time_profile_Partanen_1996___Group_1_13.png)
...
![](images/014_section_concentration-time-profiles/017_section_itraconazole-digoxin-ddi-timeprofile/comparison_time_profile_Partanen_1996___Group_2_14.png)
...
## 3.4 Rifampicin - Digoxin DDI<a id="rifampicin-digoxin-ddi-timeprofile"></a>

<a id="figure-3-15"></a>

![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Drescher_2003_15.png)

**Figure 3-15: Drescher 2003**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Greiner_1999__iv__16.png)

**Figure 3-16: Greiner 1999 (iv)**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Greiner_1999__po__17.png)

**Figure 3-17: Greiner 1999 (po)**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2006_18.png)
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2007_19.png)

**Figure 3-19: Gurley 2007**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Gurley_2008_20.png)

**Figure 3-20: Gurley 2008**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Kirby_2012_21.png)

**Figure 3-21: Kirby 2012**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Larsen_2007_22.png)

**Figure 3-22: Larsen 2007**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Reitman_2011_23.png)

**Figure 3-23: Reitman 2011**
...
![](images/014_section_concentration-time-profiles/018_section_rifampicin-digoxin-ddi-timeprofile/comparison_time_profile_Wiebe_2020_24.png)

**Figure 3-24: Wiebe 2020**

<br>
<br>

## 3.5 Verapamil - Digoxin DDI<a id="verapamil-digoxin-ddi-timeprofile"></a>

<a id="figure-3-25"></a>

![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Johnson_1987_25.png)

**Figure 3-25: Johnson 1987**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Rodin_1988_26.png)

**Figure 3-26: Rodin 1988**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Wiebe_2020_27.png)

**Figure 3-27: Wiebe 2020**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Klein_1982_28.png)

**Figure 3-28: Klein 1982**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Schwartz_1982_29.png)

**Figure 3-29: Schwartz 1982**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Belz_1983_30.png)

**Figure 3-30: Belz 1983**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Doering_1983_31.png)

**Figure 3-31: Doering 1983**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Pedersen_1983_32.png)

**Figure 3-32: Pedersen 1983**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Pedersen_1982_33.png)

**Figure 3-33: Pedersen 1982**
...
![](images/014_section_concentration-time-profiles/019_section_verapamil-digoxin-ddi-timeprofile/comparison_time_profile_Belz_1981_34.png)

**Figure 3-34: Belz 1981**

<br>
<br>

## 3.6 Clarithromycin - Dabigatran DDI<a id="clarithromycin-dabigatran-ddi-timeprofile"></a>

<a id="figure-3-35"></a>

![](images/014_section_concentration-time-profiles/020_section_clarithromycin-dabigatran-ddi-timeprofile/comparison_time_profile_Boehringer_1160_0082_35.png)

**Figure 3-35: Boehringer 1160-0082**
...
![](images/014_section_concentration-time-profiles/020_section_clarithromycin-dabigatran-ddi-timeprofile/comparison_time_profile_Delavenne_2013_36.png)

**Figure 3-36: Delavenne 2013**
...
![](images/014_section_concentration-time-profiles/020_section_clarithromycin-dabigatran-ddi-timeprofile/comparison_time_profile_Gouin_Thibault_2017_37.png)

**Figure 3-37: Gouin-Thibault 2017**
...
![](images/014_section_concentration-time-profiles/020_section_clarithromycin-dabigatran-ddi-timeprofile/comparison_time_profile_Prueksaritanont_2017_38.png)

**Figure 3-38: Prueksaritanont 2017**

<br>
<br>

## 3.7 Itraconazole - Dabigatran DDI<a id="itraconazole-dabigatran-ddi-timeprofile"></a>

<a id="figure-3-39"></a>

![](images/014_section_concentration-time-profiles/021_section_itraconazole-dabigatran-ddi-timeprofile/comparison_time_profile_Prueksaritanont_2017_39.png)

**Figure 3-39: Prueksaritanont 2017**

<br>
<br>

## 3.8 Rifampicin - Dabigatran DDI<a id="rifampicin-dabigatran-ddi-timeprofile"></a>

<a id="figure-3-40"></a>

![](images/014_section_concentration-time-profiles/022_section_rifampicin-dabigatran-ddi-timeprofile/comparison_time_profile_Boehringer_1160_0100_40.png)

**Figure 3-40: Boehringer 1160-0100**
...
![](images/014_section_concentration-time-profiles/022_section_rifampicin-dabigatran-ddi-timeprofile/comparison_time_profile_Prueksaritanont_2017_41.png)

**Figure 3-41: Prueksaritanont 2017**
...
![](images/014_section_concentration-time-profiles/022_section_rifampicin-dabigatran-ddi-timeprofile/comparison_time_profile_Rattanacheeworn_2021_42.png)

**Figure 3-42: Rattanacheeworn 2021**

<br>
<br>

## 3.9 Verapamil - Dabigatran DDI<a id="verapamil-dabigatran-ddi-timeprofile"></a>

<a id="figure-3-43"></a>

![](images/014_section_concentration-time-profiles/023_section_verapamil-dabigatran-ddi-timeprofile/comparison_time_profile_Boehringer_1160_0074_43.png)

**Figure 3-43: Boehringer 1160-0074**
